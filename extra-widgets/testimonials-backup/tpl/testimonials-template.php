...
$grid_selection =  wp_kses_post($instance['grid_style']['grid_selection']);
...
if($layout_selection == 'rotator'): ?>

    <a href="<?php $user_url = get_post_meta( $post->ID, '_cmb_testimonial_url', true );  echo $user_url; ?>">
        <?php
